...
public class ApplicationHelper {
	...
	public static void tapOnLocation(int x, int y) throws Exception {
		TouchAction action = new TouchAction(driver);
		action.press(PointOption.point(x, y)).waitAction(WaitOptions.waitOptions(Duration.ofSeconds(1))).perform();
	}
